...
void Comms_Manager::my_blink_out(int num, int delay_time, uint8_t pin)
{
...
void Comms_Manager::my_blink_out(int num, int delay_time)
{
  my_blink_out(num, delay_time, 13);
}
